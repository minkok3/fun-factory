...
{
    public class DataInitializer : DropCreateDatabaseAlways<FunFactoryDbContext>
    {
        protected override void Seed(FunFactoryDbContext context)
        {
            ...
            kit1.Components = new List<KitComponent>
            {
                new KitComponent
                {
                    Component = cpu,
